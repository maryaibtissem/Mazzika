...
@section('content')   
   ...
   <form method="post" action="traitementinfos" id="inscription" >
       ...
       {!! $errors->first('pseudo', '<small class="help-block erreur">:message</small>') !!} 
        <label >Mot de passe </label><input type="password" name="mdp" > <br><br> 
       {!! $errors->first('mdp', '<small class="help-block erreur">:message</small>') !!} 
               
        <label >Email </label><input type="text" name="email" > <br><br>
       {!! $errors->first('email', '<small class="help-block erreur">:message</small>') !!} 
        <label>&nbsp; </label><button id="boutton" name="envoyer">Envoyer</button><br><br><br>
